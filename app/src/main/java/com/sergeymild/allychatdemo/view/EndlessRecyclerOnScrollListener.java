...
public abstract class EndlessRecyclerOnScrollListener extends RecyclerView.OnScrollListener {
    ...
    private int VISIBLE_THRESHOLD = 10; // The minimum amount of items to have below your current scroll position before loading more.
    ...
    protected void stackFromBottom() {
        ...
        //check for last item
        if (!loading &&  ((totalItemCount - (totalItemCount - firstVisibleItem)) <= VISIBLE_THRESHOLD) ) {
            loading = true;
            currentPage++;

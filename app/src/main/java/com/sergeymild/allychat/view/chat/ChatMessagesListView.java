...
import com.sergeymild.allychat.adapter.MessagesAdapter;
import com.sergeymild.allychat.adapter.SectionedRecyclerViewAdapter;
import com.sergeymild.allychat.view.EndlessRecyclerOnScrollListener;
import com.sergeymild.allychat.view.SpaceItemDecorator;
                ...
                EventBus.getInstance().of(OperatorChatFragmentCallbacks.class)
                        .ifPresent(new Consumer<OperatorChatFragmentCallbacks>() {
                            ...
                            public void accept(OperatorChatFragmentCallbacks callbacks) {
                                List<Message> msgs = adapter.getMessageList();
                                callbacks.showMoreMessages(msgs.get(0), true);
                            }
                        });
            }
        };
